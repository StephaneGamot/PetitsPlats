// Importation des recettes et des fonctions getFilteredRecipes et createTag
...
function normalizeAppliance(appliance) {
    if (appliance && typeof appliance === "string" && appliance.endsWith("s") && recipes.some((recipe) => {
