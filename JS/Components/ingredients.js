...
/*
// Fonction pour filtrer les ingrédients affichés en fonction du terme de recherche
function filterDisplayedIngredients(searchTerm) {
	const ulElement = document.getElementById("ingredientsList");
	...
	listItems.forEach((listItem) => {
		const ingredient = listItem.textContent.trim().toLowerCase();
		if (ingredient.includes(searchTerm.trim().toLowerCase())) {
